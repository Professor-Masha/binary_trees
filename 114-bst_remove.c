...
/**
 * inorder_successor - Retn the minimum value of a binary search tree
...
/**
 * bst_delete - Del a node from a binary search tree
 ...
 *
 * Return: A pointer to the new root node after deletio
 *
